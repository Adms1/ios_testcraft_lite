...
//        cell.backgroundColor = GetColor.whiteColor
//        cell.labelModelSearchBar.backgroundColor = GetColor.whiteColor
//        cell.labelModelSearchBar.textColor = GetColor.blackColor
...
//        self.suggestionsShadow.backgroundColor = GetColor.whiteColor
        self.suggestionsView.backgroundColor = GetColor.whiteColor
        UIView.animate(withDuration: 0.3, delay: 0.0, options: [], animations: {
    ...
    private func getShadowY() -> CGFloat {
        return self.getGlobalPointEditText().y + self.getEditText().frame.height + 20
    }
    ...
    private func addViewToParent(view: UIView){
        if let topController = getTopViewController() {
            ...
            superView.backgroundColor = GetColor.whiteColor
